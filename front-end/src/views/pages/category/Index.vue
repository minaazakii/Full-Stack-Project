    ...
    <div class="grid">
        <div class="col-12">
            <div class="card">
                ...
                <DataTable :loading="loading" ref="dt" :value="categories" v-model:selection="selectedCategories"
                ...
                <EditProductModal @hideEditModal="hideEditModal" :toggleEditModal="toggleEditModal" :category="category">
                </EditProductModal>
